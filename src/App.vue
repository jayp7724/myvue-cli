<template>
  <div id="app">
    <main class="mw6 center">
      <add-hero-btn text="Add Hero" @add-hero="addHero"></add-hero-btn>
      <twitter-short-profile v-for="hero in heroes" :key="hero.name" :superhero="hero"></twitter-short-profile>
    </main>
...
export default {
  ...
  methods:{
    addHero(){
      this.storage.length > 0 && this.heroes.unshift(this.storage.pop())
    }
  }
}
</script>